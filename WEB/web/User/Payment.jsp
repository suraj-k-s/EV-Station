<%-- 
    Document   : Payment
    Created on : 27 Mar, 2024, 3:53:41 PM
    Author     : abhis
--%>
...
<html lang="en" >
    ...
    <body>
        ...
        if(request.getParameter("btnpay") != null){
            String updt = "update tbl_booking set booking_status = '1' where booking_id = '"+Id+"'";
                ...
                <form method="post">
                    <div class="form">
                        <div class="card space icon-relative">
                            ...
                            <input type="text" class="input" placeholder="Card Holder Name" pattern="^[A-Z]+[a-zA-Z ]*$">
