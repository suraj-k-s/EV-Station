...
//checking if request cotains multipart data
            ...
            if (isMultipart) {
                ...
                if (value[6].equals(value[7])) {//Strinh str1="insert into tbl_user ()";//inserting file
                    String InsQry = "INSERT INTO tbl_station( station_name,station_contact,station_email,station_address,place_id, station_photo,station_password)"
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Guest/StationReg.jsp';
