                ...
                <div class="sidebar pe-4 pb-3">
                    <nav class="navbar bg-secondary navbar-dark">
                        <a href="index.html" class="navbar-brand mx-4 mb-3">
                            <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Watt's Next</h3>
                        </a>    
                        <div class="d-flex align-items-center ms-4 mb-4">
                            <div class="ms-3">
                                <h6 class="mb-0"><%=session.getAttribute("aname")%></h6>
                            <span>Admin</span>
                        </div>
                    </div>
                    <div class="navbar-nav w-100">
                        <a href="HomePage.jsp" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                        <a href="District.jsp" class="nav-item nav-link"><i class="fa fa-th me-2"></i>District</a>
                        <a href="Place.jsp" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Place</a>
                        <a href="../Logout.jsp" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Logout</a>
                    </div>
                </nav>
            </div>
            <!-- Sidebar End -->
